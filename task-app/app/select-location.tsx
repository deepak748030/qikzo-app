...
const styles = StyleSheet.create({
    ...
    myLocBtn: {
        position: 'absolute', right: 6, width: 38, height: 38,
        alignItems: 'center', justifyContent: 'center',
        backgroundColor: colors.card, borderWidth: 1, borderColor: colors.foreground, zIndex: 10,
    },
    ...
    handle: { alignSelf: 'center', width: 40, height: 3, backgroundColor: colors.border, marginBottom: 8 },
