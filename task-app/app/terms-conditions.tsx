  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ padding: 6, paddingBottom: 24 }} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.p}>By using Qizko you agree to place genuine orders and provide accurate delivery details.</Text>
        ...
        <Text style={styles.p}>Qizko is not liable for delays caused by circumstances beyond our control such as weather or traffic.</Text>
      </ScrollView>
    </View>
  );
}
