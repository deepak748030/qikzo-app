...
const styles = StyleSheet.create({
  ...
  mark: { backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', borderRadius: 0 },
  markText: { color: colors.primaryForeground, fontFamily: fonts.displayBold },
  dot: { position: 'absolute', top: 5, right: 5, width: 5, height: 5, backgroundColor: colors.accent, borderRadius: 0 },
