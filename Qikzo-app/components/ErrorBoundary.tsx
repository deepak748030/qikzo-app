...
/**
 * Root error boundary. Catches render-time crashes so a single broken screen
 * doesn't nuke the entire app. Users see a friendly retry card instead of
...
export default class ErrorBoundary extends React.Component<Props, State> {
    ...
    componentDidCatch(err: any, info: any) {
        // Swallow in production; log in dev so we still see the trace.
